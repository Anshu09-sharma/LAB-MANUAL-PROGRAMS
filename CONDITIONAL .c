...
/* 2.1 WRITE A PROGRAM TO INPUT THE ANNUAL TAXABLE INCOME AND COMPUTE THE TAX ACORDING TO THE GIVEN CONDITION.
#include<stdio.h>
int main()
{
   float income,tax=0;
...
/* 2.2 WRITE A PROGRAM TO CALCULATE THE MONTHLY TELEPHONE BILLS AS PER THE FOLLOWING RULE.
#include<stdio.h>
int main()
{
   int calls;
...
/* 2.4 WRITE A PROGRAM THAT ESTIMATED THE PRICE OF RINGS FOR AN ONLINE SHOP THAT SELLS RINGS WITH CUSTOM ENGRAVINGS. THE ONLINE SHOP HAS THE FOLLOWING PRICE STRUCTURE: 
